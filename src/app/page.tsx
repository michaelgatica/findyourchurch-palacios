    ...
    <>
      <section className="hero-section">
        <div className="shell hero-section__inner">
          <div className="hero-section__copy">
            ...
            <p className="hero-section__lead">{siteConfig.heroLead}</p>
            <p className="supporting-text hero-section__scope-note">
              {siteConfig.currentListingScope}
            </p>
          ...
          <div className="hero-panel">
            ...
            <h2>{siteConfig.heroPanelTitle}</h2>
      ...
      <section className="shell section-stack">
        <div className="panel trust-banner">
          ...
          <p>
            {siteConfig.launchName} is a simple, ministry-focused directory created to help people
            find churches, view service times, and connect with local congregations.
          </p>
        </div>
      </section>
      ...
      <section className="shell section-stack">
        <div className="section-heading">
          <div>
            ...
            <h2>Start with a few churches in {siteConfig.launchAreaLabel}</h2>
          </div>
          <Link href="/churches" className="button button--ghost">
            Browse All Churches
          </Link>
