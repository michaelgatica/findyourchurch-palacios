...
export function mapChurchDocumentToChurchRecord(churchDocument: ChurchDocument): ChurchRecord {
  ...
  return {
    ...
    mailingAddress: churchDocument.mailingAddress ?? null,
...
export function mapChurchRecordToDraft(churchRecord: ChurchRecord): ChurchListingDraft {
  return {
    ...
    mailingAddress: churchRecord.mailingAddress ?? null,
...
export function buildChurchDraftFromSubmissionInput(
  ...
  return {
    ...
    mailingAddress: input.mailingAddressLine1
      ? {
          line1: input.mailingAddressLine1,
          line2: input.mailingAddressLine2,
          city: input.mailingCity ?? input.city,
          stateCode: input.mailingStateCode ?? input.stateCode,
          postalCode: input.mailingPostalCode ?? input.postalCode,
          countryCode: "US",
          latitude: null,
          longitude: null,
        }
...
export function mapDraftToChurchDocument(
  ...
  return {
    ...
    mailingAddress: churchDraft.mailingAddress ?? null,
