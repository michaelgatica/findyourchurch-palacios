...
The recommendation remains **NO-GO for opening registrations** until native screen-reader testing passes, the 9 moderate advisory nodes are explicitly accepted or remediated, the first managed backup is restored successfully, and live bounce handling is tested or explicitly accepted as a documented limitation.
